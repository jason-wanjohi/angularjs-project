...
- Add the option to fetch each user's albums on [jsonplaceholder](https://jsonplaceholder.typicode.com) and display the albums with their user.
...
- use ui-router for state management
...
You need git to clone the `angularjs-project` repository. You can get git from [here][git].

We also use a number of Node.js tools to initialize and test `angularjs-project`. You must have Node.js
and its package manager (npm) installed. You can get them from [here][node].

### Clone `angularjs-project`

Clone the `angularjs-project` repository using git:

```
git clone https://github.com/jasonwanjohi/angular-project.git
cd angular-project
```
...
* Currently tested using `NodeJS v12.20.1`
...
There are two kinds of tests in the `angular-project` application: Unit tests and end-to-end tests.

### Running Unit Tests

The `angular-project` app comes preconfigured with unit tests. These are written in [Jasmine][jasmine],
...
The `angular-project` app comes with end-to-end tests, again written in [Jasmine][jasmine]. These tests
...
up-to-date. The `angular-project` project is configured to do this automatically before running the
...
The `angular-project` project supports loading the framework and application scripts asynchronously.
...
The `angular-project` project comes preconfigured with a local development web server. It is a Node.js
...
your repository and execute scripts such as building the app or running tests. The `angular-project`
